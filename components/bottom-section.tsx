    ...
    <section className="py-20 bg-muted/20">
                    ...
                    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white px-6 py-4 md:py-6 border-t border-gray-200">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6 max-w-6xl mx-auto">
                            ...
                            <Link href="#form">
                                <div 
                                    className="bg-background cursor-pointer text-primary hover:bg-background/90 font-bold px-8 py-3 border-2 border-background/20 border-radius-lg transition-all duration-300 border-cursor-pointer border-1 border-solid"
                                    role="button"
                                    tabIndex={0}
                                >
                                    Submit
